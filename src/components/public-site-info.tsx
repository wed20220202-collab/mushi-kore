...
export function PublicSiteInfo() {
  return <aside className="public-info">
    ...
    <nav className="site-links" aria-label="サイト情報"><Link href="/pricing">無料利用について</Link><Link href="/about">むしコレについて</Link><Link href="/privacy">プライバシー</Link><Link href="/terms">利用規約</Link><Link href="/contact">お問い合わせ</Link></nav>
