...
export const categoryConfig: Record<CollectionCategory, {
  ...
  insect: { label: "昆虫", shortLabel: "むし", brand: "むしコレ", subject: "虫", subjectPlural: "虫たち", accent: "#d9ef9f", color: "#2f6b45", emoji: "🐞" },
  fish: { label: "魚", shortLabel: "うお", brand: "うおコレ", subject: "魚", subjectPlural: "魚たち", accent: "#a8dcf0", color: "#236b8e", emoji: "🐟" },
  flower: { label: "花", shortLabel: "はな", brand: "はなコレ", subject: "花", subjectPlural: "花々", accent: "#f2bfd3", color: "#a53f6d", emoji: "🌸" },
  animal: { label: "動物", shortLabel: "どう", brand: "どうコレ", subject: "動物", subjectPlural: "動物たち", accent: "#e8c59d", color: "#8a5b2f", emoji: "🐾" },
};
